...
public class Client {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("3. Type 'WHOISIN' without quotes to see a list of active clients");
        System.out.println("4. Type 'LOGOUT' without quotes to log off from the server");
        ...
        while (true) {
            ...
            // message to check who is present in the chatroom
